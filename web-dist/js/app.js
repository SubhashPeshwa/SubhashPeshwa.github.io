$(document).ready(function () {
    ...
    dom.enquireButton.click(function () {
        ...
        if (isFormValid) {
            ...
            xmlHttp.open("GET", "http://35.198.212.244:8080/mail/test?name="+name+"&email="+email+"&mobile="+mobile+"&checkin="+checkin+"&checkout="+checkout+"&kids="+kids+"&rooms="+rooms); // false for synchronous request
